                    ...
                    <Card>
                      <Card.Body className="text-white h6">
                        <small>
                          ...
                          <p className="mt-4">
                            To get started on how to use RSVP+, check out our
                            user guide (poster) using either one of these links
                            !
                          </p>
                          <ul>
                            <li>
                          ...
                          <ol>
                            ...
                            <li className="mb-1 mt-4">
                              ...
                              <ul>
                                ...
                                <li className="mt-2">
                                  Create a custom event that will be
                          ...
                          <p className="mt-4">
                            ...
                            Cal Event (later than the current time) and explore
                            the other tabs!
                          </p>
                        </small>
                      </Card.Body>
